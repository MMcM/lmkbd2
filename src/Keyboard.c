...
#define MAP_SPECIAL_SHIFT(u,s)          \
      ...
      MAP_SPECIAL_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL1,L_SYMBOL);
      MAP_SPECIAL_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL2,R_SYMBOL);
    }
    if (NKeysDown < sizeof(KeysDown)) {
      KeysDown[NKeysDown++] = usage;
    }
...
static const KeyInfo TKKeys[64] PROGMEM = {
  ...
  PC_KEY(14, HID_KEYBOARD_SC_MINUS_AND_UNDERSCORE, NULL), /* - = */
  // HID_KEYBOARD_SC_KEYPAD_AT and HID_KEYBOARD_SC_KEYPAD_CARET not mapped.
  LISP_KEY(15, HID_KEYBOARD_SC_KEYPAD_ASTERISK, KS_TK_15), /* @ ` */
  LISP_KEY(16, HID_KEYBOARD_SC_GRAVE_ACCENT_AND_TILDE, KS_TK_16), /* ^ ~ */
  PC_KEY(17, HID_KEYBOARD_SC_INSERT, NULL), /* bs */
  LISP_KEY(20, HID_KEYBOARD_SC_STOP, KS_TK_20), /* call */
  LISP_KEY(21, HID_KEYBOARD_SC_CLEAR, KS_TK_21), /* clear */
  PC_KEY(22, HID_KEYBOARD_SC_TAB, NULL), /* tab */
  LISP_KEY(23, HID_KEYBOARD_SC_F14, KS_TK_23), /* alt */
  ...
  LISP_KEY(44, HID_KEYBOARD_SC_F5, KS_TK_44), /* form */
  ...
  LISP_KEY(61, HID_KEYBOARD_SC_APOSTROPHE_AND_QUOTE, KS_TK_61), /* : * */
  PC_KEY(62, HID_KEYBOARD_SC_ENTER, NULL), /* return */
  // No HID usage for KEY_LINEFEED event.
  LISP_KEY(63, HID_KEYBOARD_SC_KEYPAD_ENTER, KS_TK_63), /* line */
  LISP_KEY(64, HID_KEYBOARD_SC_F3, KS_TK_64), /* backnext */
...
KEYSYM(KS_SC_063, ",downtack,sigma");
...
KEYSYM(KS_SC_123, ",uptack,alpha,aplalpha");
...
KEYSYM(KS_SC_163, ",righttack,delta,apldelta");
...
static const KeyInfo SpaceCadetKeys[128] PROGMEM = {
  ...
  NO_KEY(016),
  LISP_KEY(017, HID_KEYBOARD_SC_KEYPAD_9_AND_PAGE_UP, KS_SC_017), /* hand right */
  SHIFT_KEY(020, HID_KEYBOARD_SC_LEFT_CONTROL, L_CONTROL), /* left control */
  LISP_KEY(021, HID_KEYBOARD_SC_KEYPAD_ASTERISK, KS_SC_021), /* colon */
  ...
  NO_KEY(027),
  LISP_KEY(030, HID_KEYBOARD_SC_F16, KS_SC_030), /* hold output */
  ...
  SHIFT_KEY(035, HID_KEYBOARD_SC_INTERNATIONAL4, R_GREEK), /* right greek */
  ...
  LISP_KEY(040, HID_KEYBOARD_SC_F11, KS_SC_040), /* terminal */
  NO_KEY(041),
  LISP_KEY(042, HID_KEYBOARD_SC_F13, KS_SC_042), /* network */
  NO_KEY(043),
  SHIFT_KEY(044, HID_KEYBOARD_SC_INTERNATIONAL3, L_GREEK), /* left greek */
  SHIFT_KEY(045, HID_KEYBOARD_SC_LEFT_ALT, L_META), /* left meta */
  LISP_KEY(046, HID_KEYBOARD_SC_F20, KS_SC_046), /* status */
  LISP_KEY(047, HID_KEYBOARD_SC_F10, KS_SC_047), /* resume */
  LISP_KEY(050, HID_KEYBOARD_SC_F5, KS_SC_050), /* clear screen */
  ...
  NO_KEY(066),
  LISP_KEY(067, HID_KEYBOARD_SC_F18, KS_SC_067), /* abort */
  NO_KEY(070),
  ...
  LISP_KEY(100, HID_KEYBOARD_SC_F9, KS_SC_100), /* macro */
  LISP_KEY(101, HID_KEYBOARD_SC_KEYPAD_1_AND_END, KS_SC_101), /* I */
  LISP_KEY(102, HID_KEYBOARD_SC_KEYPAD_3_AND_PAGE_DOWN, KS_SC_102), /* III */
  NO_KEY(103),
  SHIFT_KEY(104, HID_KEYBOARD_SC_INTERNATIONAL1, L_TOP), /* left top */
  NO_KEY(105),
  LISP_KEY(106, HID_KEYBOARD_SC_KEYPAD_6_AND_RIGHT_ARROW, KS_SC_106), /* up thumb */
  LISP_KEY(107, HID_KEYBOARD_SC_STOP, KS_SC_107), /* call */
  // HID_KEYBOARD_SC_CLEAR and HID_KEYBOARD_SC_KEYPAD_CLEAR are the same as <DELE>.
  // HID_KEYBOARD_SC_KEYPAD_CLEAR_ENTRY is not mapped.
  LISP_KEY(110, HID_KEYBOARD_SC_F8, KS_SC_110), /* clear input */
  ...
  SHIFT_KEY(115, HID_KEYBOARD_SC_AGAIN, REPEAT), /* repeat */
  LISP_KEY(116, HID_KEYBOARD_SC_HELP, KS_SC_116), /* help */
  LISP_KEY(117, HID_KEYBOARD_SC_KEYPAD_8_AND_UP_ARROW, KS_SC_117), /* hand left */
  LISP_KEY(120, HID_KEYBOARD_SC_ESCAPE, KS_SC_120), /* quote */
  ...
  NO_KEY(140),
  LISP_KEY(141, HID_KEYBOARD_SC_F12, KS_SC_141), /* system */
  NO_KEY(142),
  LISP_KEY(143, HID_KEYBOARD_SC_F14, KS_SC_143), /* alt mode */
  NO_KEY(144),
  SHIFT_KEY(145, HID_KEYBOARD_SC_INTERNATIONAL5, L_HYPER), /* left hyper */
  // HID_KEYBOARD_SC_KEYPAD_CLOSING_BRACE not mapped
  LISP_KEY(146, HID_KEYBOARD_SC_CLOSING_BRACKET_AND_CLOSING_BRACE, KS_SC_146), /* } */
  NO_KEY(147),
  NO_KEY(150),
  ...
  SHIFT_KEY(155, HID_KEYBOARD_SC_INTERNATIONAL2, R_TOP), /* right top */
  ...
  // HID_KEYBOARD_SC_KEYPAD_OPENING_BRACE not mapped
  LISP_KEY(166, HID_KEYBOARD_SC_OPENING_BRACKET_AND_OPENING_BRACE, KS_SC_166), /* { */
  LISP_KEY(167, HID_KEYBOARD_SC_PAUSE, KS_SC_167), /* break */
  LISP_KEY(170, HID_KEYBOARD_SC_F17, KS_SC_170), /* stop output */
  ...
  SHIFT_KEY(175, HID_KEYBOARD_SC_INTERNATIONAL6, R_HYPER), /* right hyper */
  LISP_KEY(176, HID_KEYBOARD_SC_KEYPAD_7_AND_HOME, KS_SC_176), /* down thumb */
  NO_KEY(177)
};
...
#define MAP_SHIFT(u,s)          \
      ...
      MAP_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL1,L_SYMBOL);
      MAP_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL2,R_SYMBOL);
      MAP_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL3,L_GREEK);
      MAP_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL4,R_GREEK);
      MAP_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL5,L_HYPER);
      MAP_SHIFT(HID_KEYBOARD_SC_INTERNATIONAL6,R_HYPER);
      MAP_SHIFT(HID_KEYBOARD_SC_AGAIN,REPEAT);
...
static const KeyInfo SMBXKeys[128] PROGMEM = {
  ...
  SHIFT_KEY(004, HID_KEYBOARD_SC_INTERNATIONAL5, L_HYPER), /* left hyper */
  ...
  NO_KEY(013),
  NO_KEY(014),
  LISP_KEY(015, HID_KEYBOARD_SC_F12, KS_SM_015), /* select */
  SHIFT_KEY(016, HID_KEYBOARD_SC_INTERNATIONAL1, L_SYMBOL), /* left symbol */
  ...
  SHIFT_KEY(023, HID_KEYBOARD_SC_INTERNATIONAL6, R_HYPER), /* right hyper */
  ...
  SHIFT_KEY(036, HID_KEYBOARD_SC_AGAIN, REPEAT), /* repeat */
  ...
  SHIFT_KEY(051, HID_KEYBOARD_SC_INTERNATIONAL2, R_SYMBOL), /* right symbol */
  ...
  LISP_KEY(065, HID_KEYBOARD_SC_F15, KS_SM_065), /* complete */
  NO_KEY(066),
  NO_KEY(067),
  NO_KEY(070),
  LISP_KEY(071, HID_KEYBOARD_SC_F13, KS_SM_071), /* network */
  ...
  NO_KEY(102),
  NO_KEY(103),
  LISP_KEY(104, HID_KEYBOARD_SC_F11, KS_SM_104), /* function */
  ...
  LISP_KEY(113, HID_KEYBOARD_SC_F19, KS_SM_113), /* page */
  NO_KEY(114),
  NO_KEY(115),
  NO_KEY(116),
  ...
  NO_KEY(130),
  NO_KEY(131),
  // HID_KEYBOARD_SC_KEYPAD_COLON not mapped in evdev HID
  LISP_KEY(132, HID_KEYBOARD_SC_KEYPAD_ASTERISK, KS_SM_132), /* : */
  ...
  PC_KEY(141, HID_KEYBOARD_SC_OPENING_BRACKET_AND_OPENING_BRACE, KS_SM_141), /* \ { */
  NO_KEY(142),
  NO_KEY(143),
  NO_KEY(144),
  ...
  LISP_KEY(154, HID_KEYBOARD_SC_CLOSING_BRACKET_AND_CLOSING_BRACE, KS_SM_154), /* | } */
  NO_KEY(155),
  NO_KEY(156),
  NO_KEY(157),
  LISP_KEY(160, HID_KEYBOARD_SC_ESCAPE, KS_SM_160), /* escape */
  LISP_KEY(161, HID_KEYBOARD_SC_F5, KS_SM_161), /* refresh */
  LISP_KEY(162, HID_KEYBOARD_SC_F22, KS_SM_162), /* square */
  LISP_KEY(163, HID_KEYBOARD_SC_F23, KS_SM_163), /* circle */
  LISP_KEY(164, HID_KEYBOARD_SC_F24, KS_SM_164), /* triangle */
  LISP_KEY(165, HID_KEYBOARD_SC_F8, KS_SM_165), /* clear input */
  LISP_KEY(166, HID_KEYBOARD_SC_PAUSE, KS_SM_166), /* suspend */
  LISP_KEY(167, HID_KEYBOARD_SC_F10, KS_SM_167), /* resume */
  NO_KEY(170),
  NO_KEY(171),
  NO_KEY(172),
  NO_KEY(173),
...
static const KeyInfo ExplorerKeys[128] PROGMEM = {
  ...
  SHIFT_KEY(007, HID_KEYBOARD_SC_INTERNATIONAL5, L_HYPER), // LEFT-HYPER
  LISP_KEY(010, HID_KEYBOARD_SC_F12, KS_TI_010), // SYSTEM
  LISP_KEY(011, HID_KEYBOARD_SC_F13, KS_TI_011), // NETWORK
  LISP_KEY(012, HID_KEYBOARD_SC_SYSREQ, KS_TI_012), // STATUS
  LISP_KEY(013, HID_KEYBOARD_SC_OPER, KS_TI_013), // TERMINAL
  NO_KEY(014),
  LISP_KEY(015, HID_KEYBOARD_SC_F5, KS_TI_015), // CLEAR-SCREEN
  LISP_KEY(016, HID_KEYBOARD_SC_F8, KS_TI_016), // CLEAR-INPUT
  LISP_KEY(017, HID_KEYBOARD_SC_UNDO, KS_TI_017), // UNDO
  PC_KEY(020, HID_KEYBOARD_SC_END, NULL), // END
  LISP_KEY(021, HID_KEYBOARD_SC_F22, KS_TI_021), // LEFT (mouse keys? like i ii iii?)
  LISP_KEY(022, HID_KEYBOARD_SC_F23, KS_TI_022), // MIDDLE
  LISP_KEY(023, HID_KEYBOARD_SC_F24, KS_TI_023), // RIGHT
  ...
  SHIFT_KEY(040, HID_KEYBOARD_SC_INTERNATIONAL6, R_HYPER), // RIGHT-HYPER
  LISP_KEY(041, HID_KEYBOARD_SC_F10, KS_TI_041), // RESUME
  NO_KEY(042),
  ...
  PC_KEY(060, HID_KEYBOARD_SC_OPENING_BRACKET_AND_OPENING_BRACE, NULL), // BACK-QUOTE (` {)
  PC_KEY(061, HID_KEYBOARD_SC_CLOSING_BRACKET_AND_CLOSING_BRACE, NULL), // TILDE (~ })
  ...
  LISP_KEY(066, HID_KEYBOARD_SC_PAUSE, KS_TI_066), // BREAK
  NO_KEY(067),
  ...
  NO_KEY(144),
  NO_KEY(145),
  SHIFT_KEY(146, HID_KEYBOARD_SC_INTERNATIONAL1, L_SYMBOL), // LEFT-SYMBOL
  ...
  NO_KEY(163),
  SHIFT_KEY(164, HID_KEYBOARD_SC_INTERNATIONAL2, R_SYMBOL), // RIGHT-SYMBOL
